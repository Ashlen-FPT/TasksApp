...
namespace TasksApp.Controllers
{
    public class SecuritiesController : Controller
    {
        ...
        public async Task<IActionResult> GetTasksTodayAsync(DateTime date)
        {
            ...
            var TasksToday = _context.Security.Where(d => d.DateCreated.Date == oDate.Date).Where(s => s.TaskCategory == "Security").Where(s => s.Schedule == "Daily").ToList();
        ...
        public async Task<IActionResult> CompleteTask(int id)
        {
            ...
            if (tasks.All(c => c.IsDone == true))
            {
                if (getPDate == Ddate && tasks.Count == 1)
                {
                    ...
                    ChangeToPartialStatus.Status = "Completed : Security";
                }
        ...
        public IActionResult AdminGetAll(DateTime date)
        {
            ...
            return Json(new { data = _context.Security.Where(d => d.DateCreated.Date == oDate.Date).Where(s => s.Schedule == "Daily") });
